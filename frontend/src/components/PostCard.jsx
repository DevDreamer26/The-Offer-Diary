...
export default function PostCard({ post }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-xl hover:shadow-blue-500/5 transition-all group">
      ...
      <div className="flex items-center justify-between pt-4 border-t border-gray-50 dark:border-gray-800">
        <div className="flex items-center gap-2">
          ...
          <Link to={`/profile/${post.author.username}`} className="text-sm font-semibold text-gray-700 dark:text-gray-300">
